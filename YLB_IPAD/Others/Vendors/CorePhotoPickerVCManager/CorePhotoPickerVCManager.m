...
-(void)imagePickerControllerDidCancel:(UIImagePickerController *)picker{
    ...
    //直接取消
    if (self.cancelPickingMedia != nil) {
        _cancelPickingMedia();
    }
...
-(void)uzysAssetsPickerControllerDidExceedMaximumNumberOfSelection:(UzysAssetsPickerController *)picker{
    NSLog(@"超过选取上限");
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"提示" message:@"最多只能选择3张照片！" preferredStyle:UIAlertControllerStyleAlert];
...
-(CorePhotoPickerUnavailableType)tranformCorePhotoPickerVCMangerTypeForUnavailableType:(CorePhotoPickerVCMangerType)type{
    ...
    return CorePhotoPickerUnavailableTypeNone;
}
