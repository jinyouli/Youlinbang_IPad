...
- (void)addGPSLocation:(NSMutableDictionary *)metaData {
    ...
    if (self.location != nil) {
        ...
        if ([metaData objectForKey:(__bridge NSString*)kCGImagePropertyGPSDictionary]) {
            [locDict addEntriesFromDictionary:[metaData objectForKey:(__bridge NSString*)kCGImagePropertyGPSDictionary]];
        }
        [locDict setObject:[self getUTCFormattedDate:location.timestamp] forKey:(__bridge NSString*)kCGImagePropertyGPSTimeStamp];
        [locDict setObject:latRef forKey:(__bridge NSString*)kCGImagePropertyGPSLatitudeRef];
        [locDict setObject:[NSNumber numberWithFloat:exifLatitude] forKey:(__bridge NSString*)kCGImagePropertyGPSLatitude];
        [locDict setObject:lngRef forKey:(__bridge NSString*)kCGImagePropertyGPSLongitudeRef];
        [locDict setObject:[NSNumber numberWithFloat:exifLongitude] forKey:(__bridge NSString*)kCGImagePropertyGPSLongitude];
        [locDict setObject:[NSNumber numberWithFloat:location.horizontalAccuracy] forKey:(__bridge NSString*)kCGImagePropertyGPSDOP];
        [locDict setObject:[NSNumber numberWithFloat:location.altitude] forKey:(__bridge NSString*)kCGImagePropertyGPSAltitude];
        
        [metaData setObject:locDict forKey:(__bridge NSString*)kCGImagePropertyGPSDictionary];
    }
}
