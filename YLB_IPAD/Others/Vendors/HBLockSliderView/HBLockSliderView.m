...
//#define kCornerRadius self.bounds.size.height * 0.5  //默认圆角为5
#define kBorderWidth 1 //默认边框为2
#define kAnimationSpeed 0.5 //默认动画移速
//#define kForegroundColor [UIColor colorWithRed:255.0f/255.0f green:175.0f/255.0f blue:5.0f/255.0f alpha:1.0f] //默认滑过颜色
//#define kBackgroundColor [UIColor colorWithRed:255.0f/255.0f green:175.0f/255.0f blue:5.0f/255.0f alpha:1.0f] //默认未滑过颜色
#define kThumbColor [UIColor lightGrayColor] //默认Thumb颜色
#define kBorderColor UIColorFromRGB(0xd0cbec)//默认边框颜色
...
- (instancetype)initWithFrame:(CGRect)frame cornerRadius:(CGFloat)cornerRadius kForegroundColor:(UIColor *)kForegroundColor kBackgroundColor:(UIColor *)kBackgroundColor{
    if (self = [super initWithFrame:frame]) {
        
        self.kcornerRadius = cornerRadius;
        self.kForegroundColor = kForegroundColor;
        self.kBackgroundColor = kBackgroundColor;
...
- (void)setupUI{
    ...
    _thumbImageView.layer.cornerRadius = self.kcornerRadius;
    _thumbImageView.layer.masksToBounds = YES;
    _thumbImageView.userInteractionEnabled = YES;
    
    [self addSubview:_thumbImageView];
    self.layer.cornerRadius = self.kcornerRadius;
    ...
    _foregroundView.backgroundColor = self.kForegroundColor;
