 ...
 *  普通状态下外空心圆颜色
 */
#define CircleStateNormalOutsideColor rgba(85,85,85,1)
 ...
 *  普通状态下文字提示的颜色
 */
#define textColorNormalState rgba(85,85,85,1)

/**
 *  警告状态下文字提示的颜色
 */
#define textColorWarningState rgba(210,48,35,1)

/**
 *  绘制解锁界面准备好时，提示文字
 */
#define gestureTextBeforeSet @"为了您的账号安全，请录入手势密码！"
 ...
 *  绘制解锁图案
 */
#define gestureTextSettingGesture @"绘制解锁图案"
